...
/**
 * §6.4 — the weekly "5 students at risk: …" instructor digest. Only ever
 * dispatched when at least one enrollment is flagged (§6.4's "optional" —
 * no email when there's nothing to say); the command that sends this never
