  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    :root{
      ...
      --gold:#b8933f; --gold-d:#93752f; --gold-soft:#f7f0df; --ok:#15803d; --ok-soft:#e6f4ea;
    ...
    .hd-r form button{background:none;border:none;color:var(--tx2);cursor:pointer;font-size:13px;font-family:var(--font);}
    ...
    .btn{display:inline-flex;align-items:center;gap:7px;font-size:13px;font-weight:500;padding:9px 16px;border:1px solid var(--pri);background:var(--pri);color:#fff;}
...
<header class="app">
  <div class="bar">
    <a href="{{ route('dashboard') }}" class="brand"><span class="badge">MM</span> Muhindo Mubaraka</a>
    <nav class="nav">
      @if($u?->isStudent())
